...
#import "TD_FMDatabase+FTS3.h"
#import "TD_fts3_tokenizer.h"
...
@implementation TD_FMDatabase (FTS3)
...
- (BOOL)installTokenizerModule
{
    ...
    TD_FMResultSet *results = [self executeQuery:@"SELECT fts3_tokenizer('fmdb', ?)", tokenizerData];
...
@implementation TD_FMTextOffsets
{
...
@implementation TD_FMResultSet (FTS3)

- (TD_FMTextOffsets *)offsetsForColumnIndex:(int)columnIdx
{
    ...
    return [[TD_FMTextOffsets alloc] initWithDBOffsets:rawOffsets];
}
