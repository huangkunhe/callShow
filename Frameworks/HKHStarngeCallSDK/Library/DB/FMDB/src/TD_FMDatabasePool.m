...
@interface TD_FMDatabasePool()

- (void)pushDatabaseBackInPool:(TD_FMDatabase*)db;
- (TD_FMDatabase*)db;

@end


@implementation TD_FMDatabasePool
...
- (TD_FMDatabase*)db {
    ...
    [self executeLocked:^() {
        ...
        if (db) {
            ...
            db = [TD_FMDatabase databaseWithPath:self->_path];
