...
@interface TD_FMResultSet : NSObject {
    TD_FMDatabase          *_parentDB;
    TD_FMStatement         *_statement;
...
@property (atomic, retain) TD_FMStatement *statement;
...
+ (instancetype)resultSetWithStatement:(TD_FMStatement *)statement usingParentDatabase:(TD_FMDatabase*)aDB;

/** Close result set */

- (void)close;

- (void)setParentDB:(TD_FMDatabase *)newDb;
